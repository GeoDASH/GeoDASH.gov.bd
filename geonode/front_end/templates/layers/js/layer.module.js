(function() {
    angular.module('LayerApp', ['ui.grid', 'ui.grid.pagination', 'ui.grid.exporter','ui.grid.autoResize', 'ui.grid.resizeColumns', 'ui.grid.moveColumns','angularFileUpload', 'surfToastr'])
