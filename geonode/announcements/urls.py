...
from geonode.announcements.views import detail, dismiss
from geonode.announcements.views import CreateAnnouncementView, UpdateAnnouncementView
from geonode.announcements.views import DeleteAnnouncementView, AnnouncementListView
